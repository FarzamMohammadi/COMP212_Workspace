...
namespace Q1Lab3
{
    public class Country
    {
        ...
        //Question01 - List the names of the countries in alphabetical order.
        public static List<string> countryNamesInAlphabeticalOrder()
        {
            List<string> namesInORder = new List<string>();
            namesInORder.Add("Exercise 01 - Q1 - Country Names In Alphabetical Order:");
            namesInORder.Add("");
            var countryNames = from countries in Country.GetCountries()
                               orderby countries.Name
                               select countries.Name;
            foreach (var item in countryNames)
            {
                namesInORder.Add(item.ToString());
            }
            return namesInORder;

        }

        //Questions02 - List the names of the countries in descending order of number of resources.
        public static List<string> countryNamesInDescendingNumberOfResources()
        {
            List<string> basedOnDescendingResources = new List<string>();
            basedOnDescendingResources.Add("Exercise 01 - Q2 - Countries In Descending Order of Number of Resources:");
            basedOnDescendingResources.Add("");

            var resources = from countries in Country.GetCountries()
                            .OrderByDescending(x => x.Resources.Count)
                            select countries.Name;

            foreach (var item in resources)
            {
                basedOnDescendingResources.Add(item.ToString());
            }

            return basedOnDescendingResources;
        }

        //Questions03 - List the names of the countries that shares a border with Argentina.
        public static List<string> bordersArgentina()
        {
            List<string> bordersArgentina = new List<string>();
            bordersArgentina.Add("Exercise 01 - Q3 - Countries That Share A Border With Argentina:");
            bordersArgentina.Add("");

            var argentinaBorders = from countries in Country.GetCountries()
                                   where countries.Name == "Argentina"
                                   select countries.Borders;

            foreach (var items in argentinaBorders)
            {
                foreach (var item in items)
                {
                    bordersArgentina.Add(item.ToString());
                }
            }

            return bordersArgentina;

        }

        //Question04 - List the names of the countries that has more than 10,000,000 population.
        public static List<string> countriesOverTenMilPopulation()
        {
            List<string> countryOverTenMillion = new List<string>();
            countryOverTenMillion.Add("Exercise 01 - Q4 - Countries With Greater Than 10,000,000 population:");
            countryOverTenMillion.Add("");

            var namesOfOverTenMil = from countries in Country.GetCountries()
                                    where countries.Population > 10000000
                                    select countries.Name;

            foreach (var item in namesOfOverTenMil)
            {
                countryOverTenMillion.Add(item.ToString());
            }

            return countryOverTenMillion;


        }

        //Question05 - List the country with highest population.
        public static List<string> countryWithMaxPopulation()
        {

            List<string> maxPopulationCountry = new List<string>();

            maxPopulationCountry.Add("Exercise 01 - Q5 - Country With Highest Population population:");
            maxPopulationCountry.Add("");

            var namesOfOverTenMil = (from country in Country.GetCountries()
                                    .OrderByDescending(x => x.Population)
                                     select country.Name).First().ToString();
            
            maxPopulationCountry.Add(namesOfOverTenMil.ToString());
